 ...
 */
@ActivityScope
public class TestUserPresenter extends BasePresenter<TestUserContract.Model, TestUserContract.View> {
    @Inject
    ...
    @Inject
    public TestUserPresenter(TestUserContract.Model model, TestUserContract.View rootView) {
    ...
    public void requestUsers(final boolean pullToRefresh) {
        ...
        mModel.getUsers(lastUserId, isEvictCache)
                ...
                .subscribe(new ErrorHandleSubscriber<List<TestUser>>(mErrorHandler) {
                    @Override
                    public void onNext(List<TestUser> users) {
