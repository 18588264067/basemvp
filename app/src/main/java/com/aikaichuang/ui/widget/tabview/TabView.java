package com.aikaichuang.ui.widget.tabview;
...
public class TabView extends RelativeLayout {
    ...
    /**
     * jump to place on order
     */
    private TextView centerOrderButton = null;
    /**
    ...
    private void initDefaultAttrs(Context context){
        ...
        mImageViewWidth=TabViewUtil.dp2px(context,20);
        mImageViewHeight=TabViewUtil.dp2px(context,20);
    ...
    void addCenterOrderButton(TabViewChild child) {
        ...
        centerOrderButton = new TextView(getContext());
        centerOrderButton.setTextColor(mTextViewUnSelColor);
        centerOrderButton.setBackgroundResource(child.getImageViewSelIcon());
        layoutParams.bottomMargin = ArmsUtils.dip2px(getContext(), 5);
        layout.addView(centerOrderButton);
        addView(layout, layoutParams);
        centerOrderButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(listener!=null){
                    listener.onTabChildClick(-1,null,null);
                }
            }
        });
    }
    ...
    private void showOrHide() {
        if (mFragments[index] == null) {
            centerOrderButton.performClick();
            return;
        }
