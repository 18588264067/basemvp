...
import com.aikaichuang.ui.widget.selectPic.SimpleRxGalleryFinal;
 ...
 *         with(TestSelectPicMainActivity.this)
 *         image()
 *         radio();
 */
public class TestSelectPicMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_select_pic_activity_main);
    ...
    private void openCrop() {
        if (mRbCropZD.isChecked()) {
            //直接裁剪
            String inputImg = "";
            Toast.makeText(TestSelectPicMainActivity.this, "没有图片演示，请选择‘拍照裁剪’功能", Toast.LENGTH_SHORT).show();
            //  RxGalleryFinalApi.cropScannerForResult(TestSelectPicMainActivity.this, RxGalleryFinalApi.getModelPath(), inputImg);//调用裁剪.RxGalleryFinalApi.getModelPath()为模拟的输出路径
        } else {
            //            RxGalleryFinalApi.openZKCamera(TestSelectPicMainActivity.this);
            ...
            SimpleRxGalleryFinal.get().init(
                    new SimpleRxGalleryFinal.RxGalleryFinalCropListener() {
                        ...
                        public Activity getSimpleActivity() {
                            return TestSelectPicMainActivity.this;
                        }
...
//        RxGalleryFinal.with(this).hidePreview();
    ...
    private void openVideoSelectRadioMethod() {
        RxGalleryFinalApi
                .getInstance(TestSelectPicMainActivity.this)
    ...
    private void openImageSelectRadioMethod(int type) {
        RxGalleryFinalApi instance = RxGalleryFinalApi.getInstance(TestSelectPicMainActivity.this);
        switch (type) {
            case 0:
            ...
            case 2:
                ...
                RxGalleryFinalApi
                        .openRadioSelectImage(TestSelectPicMainActivity.this, new RxBusResultDisposable<ImageRadioResultEvent>() {
                            @Override
...
//            //刷新相册数据库
//            RxGalleryFinalApi.openZKCameraForResult(TestSelectPicMainActivity.this, new MediaScanner.ScanCallback() {
//                @Override
...
//                    RxGalleryFinalApi.cropScannerForResult(TestSelectPicMainActivity.this, RxGalleryFinalApi.getModelPath(), strings[0]);//调用裁剪.RxGalleryFinalApi.getModelPath()为默认的输出路径
//                }
//            });
//        } else {
//            Logger.i("失敗");
